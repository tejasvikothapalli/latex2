# Source: https://github.com/full-stack-deep-learning/fsdl-text-recognizer-2021-labs/blob/36cab9d6dcdad84e3d1a69df5ab796cbf689c115/lab7/text_recognizer/models/transformer_util.py
import math
import torch
